...
| `services/feed-social-service` | Go `1.24`, toolchain `go1.24.13` | `github.com/jackc/pgx/v5 v5.8.0`, `github.com/segmentio/kafka-go v0.4.51`, `github.com/redis/go-redis/v9 v9.20.1` |
| `services/live-service` | Go `1.24`, toolchain `go1.24.13` | `github.com/jackc/pgx/v5 v5.8.0` |
