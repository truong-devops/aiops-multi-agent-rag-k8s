...
Tài liệu chuẩn hóa cách phát triển, quản lý dependency, tooling và workflow kỹ thuật dùng chung cho toàn repo.

- [Dependency Versioning](./dependency-versioning.md)
